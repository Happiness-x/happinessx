...
export default function App() {
  ...
  <nav className="nav-animated fixed top-0 w-full bg-black/40 backdrop-blur-md text-cyan-200 py-4 px-6 flex justify-center space-x-8 border-b border-cyan-900 z-50">
      ...
      <section
        id="home"
        data-aos="fade-up"
        className="min-h-screen flex flex-col items-center justify-center text-center p-8 space-y-8 bg-[url('/healing-bg1.jpg')] bg-cover bg-center relative"
      >
        ...
        <div className="relative z-10">
          ...
          {/* Signature */}
          <div className="flex items-center justify-center gap-3 text-cyan-300 text-lg font-medium mb-10">
            <span>
              By Empath Healer{" "}
              <span className="font-semibold text-cyan-400">
                Tapobroto Bhattacharya
              </span>
            </span>
            <img
              src="/BT LOGO.png"
              alt="Empath Healer Logo"
              className="w-10 h-10 rounded-full border border-cyan-700 shadow-[0_0_15px_#06b6d4] hover:scale-105 transition"
            />
          </div>
